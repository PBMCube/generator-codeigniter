                ...
                return {
                    ...
                    compile: function compile(tElement, tAttrs, transclude) {
                        return function link(scope, iElement, iAttrs, controller, transcludeFn) {
                            ...
                            var options = $.extend(defaults, scope.$eval(iAttrs.ngColumnifyOptions));
                            ...
                            $('<!-- ngColumnify -->').insertBefore(iElement);
                            ...
                            var _setupColumns = function() {
                                ...
                                $('.column', iElement).remove();

                                colsArr = [];
                                for (var i = 0; i < Math.max(1, scope.columns); i++) {
                                    colsArr.unshift({
                                        $el: $('<div class="column"/>').prependTo(iElement),
                                        height: 0
                                    });
                                }
                            };
                            ...
                            var _flow = function(_items) {
                                var tmp = $('<div class="temp" style="visibility: hidden;" />').appendTo(iElement);
